...
public static class Deserializer
{
    ...
    private static void AddDebugHooks(this XmlSerializer serializer)
    {
        ...
        serializer.UnknownAttribute += (sender, args) =>
                                       {
                                           ...
                                           string msg =
                                               $"{args.LineNumber}:{args.LinePosition},{args.ObjectBeingDeserialized.GetType()},Unknown attribute,{attr.Name},{attr.Value}";
        ...
        serializer.UnknownNode += (sender, args) =>
                                  {
                                      string msg =
                                          $"{args.LineNumber}:{args.LinePosition},{args.ObjectBeingDeserialized.GetType()},Unknown Node,{args.Name},{args.Text}";
                                      uknowns.AppendLine(msg);
        ...
        serializer.UnknownElement += (sender, args) =>
                                     {
                                         string msg =
                                             $"{args.LineNumber}:{args.LinePosition},{args.ObjectBeingDeserialized.GetType()},Unknown Element,{args.Element.Name},{args.Element.InnerXml}";
                                         uknowns.AppendLine(msg);
                                         uknownTags
                                            .Add($"{args.ObjectBeingDeserialized.GetType()},{args.Element.Name}");
                                     };

        serializer.UnreferencedObject += (sender, args) =>
                                         {
                                             string msg =
                                                 $"0:0,{args.UnreferencedObject.GetType()},Unreferenced Object,{args.UnreferencedId},{args.UnreferencedObject}";
                                             uknowns.AppendLine(msg);
                                         };
    }
