...
public class TickType : Enumeration<TickType>
{
    ...
    public static TickType OptionCallOpenInterest = new(IBTick.OPTION_CALL_OPEN_INTEREST, nameof(OptionCallOpenInterest));
    ...
    public static TickType CreditmanSlowMarkPrice = new(IBTick.CREDITMAN_SLOW_MARK_PRICE, nameof(CreditmanSlowMarkPrice));
