...
public class OutgoingMessage : Enumeration<OutgoingMessage, string>
{
    ...
    public static OutgoingMessage RequestScannerSubscription =
        new("REQ_SCANNER_SUBSCRIPTION", nameof(RequestScannerSubscription));

    public static OutgoingMessage CancelScannerSubscription =
        new("CANCEL_SCANNER_SUBSCRIPTION", nameof(CancelScannerSubscription));

    public static OutgoingMessage RequestScannerParameters =
        new("REQ_SCANNER_PARAMETERS", nameof(RequestScannerParameters));
    ...
    public static OutgoingMessage RequestCalcImpliedVolatility =
        new("REQ_CALC_IMPLIED_VOLAT", nameof(RequestCalcImpliedVolatility));

    public static OutgoingMessage RequestCalcOptionPrice = new("REQ_CALC_OPTION_PRICE", nameof(RequestCalcOptionPrice));

    public static OutgoingMessage CancelCalcImpliedVolatility =
        new("CANCEL_CALC_IMPLIED_VOLAT", nameof(CancelCalcImpliedVolatility));

    public static OutgoingMessage CancelCalcOptionPrice =
        new("CANCEL_CALC_OPTION_PRICE", nameof(CancelCalcOptionPrice));
