...
public class GenericTickType : Enumeration<GenericTickType, int>
{
    ...
    public static GenericTickType OptionOpenInterest      = new(101, nameof(OptionOpenInterest), "Option Open Interest (currently for stocks)");
    public static GenericTickType HistoricalVolatility    = new(104, nameof(HistoricalVolatility), "Historical Volatility (currently for stocks)");
    public static GenericTickType AvgOptionVolume         = new(105, nameof(AvgOptionVolume), "Average Option Volume (currently for stocks)");
    public static GenericTickType OptionImpliedVolatility = new(106, nameof(OptionImpliedVolatility), "Option Implied Volatility (currently for stocks)");
    ...
    public static GenericTickType AuctionPrice            = new(225, nameof(AuctionPrice), "Auction values (volume, price and imbalance)");
    public static GenericTickType RTVolume                = new(233, nameof(RTVolume), "RTVolume - contains the last trade price, last trade size, last trade time, total volume, VWAP, and single trade flag.");
