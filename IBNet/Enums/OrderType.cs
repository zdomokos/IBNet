...
public class OrderType : Enumeration<OrderType, string>
{
    ...
    /// </summary>
    public static OrderType Market = new("MKT", nameof(Market));
    ...
    public static OrderType MarketOnClose = new("MOC", nameof(MarketOnClose));

    /// <summary>
    /// A limit order is an order to buy or sell a contract at a specified price or better.
    /// Bonds, Forex, Futures, Future Options, Options, Stocks, Warrants
    /// </summary>
    public static OrderType Limit = new("LMT", nameof(Limit));
    ...
    /// </summary>
    public static OrderType LimitOnClose = new("LOC", nameof(LimitOnClose));
    ...
    /// Stocks
    /// </summary>
    public static OrderType PeggedToMarket = new("PEGMKT", nameof(PeggedToMarket));
    ...
    /// </summary>
    public static OrderType Stop = new("STP", nameof(Stop));
    ...
    /// </summary>
    public static OrderType StopLimit = new("STP LMT", nameof(StopLimit));
    ...
    /// Forex, Futures, Future Options, Options, Stocks, Warrants
    /// </summary>
    public static OrderType TrailingStop = new("TRAIL", nameof(TrailingStop));
    ...
    /// Options, Stocks
    /// </summary>
    public static OrderType Relative = new("REL", nameof(Relative));
    ...
    /// Stocks
    /// </summary>
    public static OrderType VolumeWeightedAveragePrice = new("VWAP", nameof(VolumeWeightedAveragePrice));
    ...
    /// Forex, Futures, Future Options, Options, Stocks, Warrants
    /// </summary>
    public static OrderType TrailingStopLimit = new("TRAILLIMIT", nameof(TrailingStopLimit));
    ...
    /// </summary>
    public static OrderType Volatility = new("VOL", nameof(Volatility));
    ...
    /// </summary>
    public static OrderType None = new("NONE", nameof(None));

    /// <summary>
    /// Used to initialize the delta Order Field.
    /// </summary>
    public static OrderType Empty = new("", nameof(Empty));

    /// <summary>
    /// Default - used for Delta Neutral Order Type
    /// </summary>
    public static OrderType Default = new("Default", nameof(Default));

    /// <summary>
    /// Scale Order.
    /// </summary>
    public static OrderType Scale = new("SCALE", nameof(Scale));

    /// <summary>
    /// Market if Touched Order.
    /// </summary>
    public static OrderType MarketIfTouched = new("MIT", nameof(MarketIfTouched));
